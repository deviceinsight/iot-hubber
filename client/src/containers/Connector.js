    ...
    return (
      <div className="connector">
        ...
        <LabelledBox title="certificate.pem">
          <FileUpload accept="pem" onUpload={this.onUploadCertificate} selectedFile={certCert} />
        </LabelledBox>
        <LabelledBox title="certificate.key">
          <FileUpload accept="key" onUpload={this.onUploadCertificateKey} selectedFile={certKey} />
        </LabelledBox>
